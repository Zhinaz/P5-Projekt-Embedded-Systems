...
\fxnote{Skriv noget mere intro til dette}
This section contains a short description of all the available states for the \projname{}. These states are used to determine what process the robot is currently in and to ensure that the robot is always doing as expected. All of the states and their connections can be seen in \figref{fig:robot-behaviour}.
...
\begin{figure}[H]
     ...
     \caption{\label{fig:robot-behaviour} The robots different states and their connections}
\end{figure}
