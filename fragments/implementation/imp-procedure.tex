...
The last iteration was supposed to implement the NN-algorithm described in \secref{sec:nn-algorithm}, but due to the limitations this algorithm was disregarded. The source code of the NN-algorithm can be found in \appref{app:CD}.
